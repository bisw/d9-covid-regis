 ...
 *
 * @Block(
 *   id = "covid_vaccine_centre",
 *   admin_label = @Translation("Covid Vaccine Centre"),
 *   category = @Translation("Custom"),
 * )
 */
class VaccineCentre extends BlockBase {
  ...
  public function build() {
    ...
    $output = views_embed_view('all_vaccine_centre', 'block_1', $city);
